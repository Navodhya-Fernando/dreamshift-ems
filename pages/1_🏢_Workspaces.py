...
/* Badges (keep your existing badge classes if present) */
.ds-badge{
  padding: 6px 10px;
  border-radius: 999px;
  font-size: 0.78rem;
...
/* Make tabs look cleaner (optional) */
...
.stTabs [aria-selected="true"]{
  background: rgba(246,185,0,0.10) !important;
  border-color: rgba(246,185,0,0.28) !important;
  color: rgba(246,185,0,0.98) !important;
}
